            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div className="grid gap-5 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
                    <div className="overflow-hidden transition-shadow duration-300 bg-white rounded">
                        ...
                        <div className="py-5">
                            <p className="mb-2 text-xs font-semibold text-ally8 uppercase">
                                28 Dec 2022
                            </p>
                            <a
                                href="https://nami.org/Blogs/NAMI-Blog/December-2022/Supporting-Mental-Health-in-The-Workplace"
                                ...
                                >
                                    <div className="mr-2">
                                        <svg
                                            ...
                                            strokeWidth="2"
                                            className="w-5 h-5 text-ally2 transition-colors duration-200 group-hover:text-deep-purple-accent-700"
                                        >
                                            <polyline
